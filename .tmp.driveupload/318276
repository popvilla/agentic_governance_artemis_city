...
**Artemis City** (v0.1.0) is an architectural framework for agentic reasoning with transparent, accountable action across distributed intelligence systems. It combines Python-based agent orchestration with a Node.js/TypeScript memory layer to enable AI agents to operate with clear roles, boundaries, and trust management.
...
- `#SpecialNotes:` - Unusual instructions or warnings
...
5. Load agent instructions from `src/agents/<name>.md`
...
- `release.yml`: Package building and release
